...
class dBOperation:
    ...
    def createDatabasesForPrediction(self, Databases):
        try:
            """
                    Method Name: createDatabaseForPrediction
                    Description: This method crates database for prediction operation i.e logging, storing data in database
                    Output: None
    ...
    def dataBaseConnection(self,DatabaseName):
        ...
        try:
            conn = connection.connect(host="localhost", database=DatabaseName, user="root", password="password",
                                      use_pure=True)
    ...
    def insertIntoTableGoodData(self,TableName):
        ...
        for file in onlyfiles:
            try:
                ...
                self.logger.log(logging_db, logging_tableName, 'ERROR',
