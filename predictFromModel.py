...
class prediction:
    ...
    def predictionFromModel(self):
        ...
        try:
            ...
            self.log_writer.log(self.db, self.table_name, 'INFO', 'Start of Prediction')
            data_getter=data_loader_prediction.Data_Getter_Pred(self.db, self.table_name, self.log_writer)
            ...
            file_loader=file_methods.File_Operation(self.db, self.table_name, self.log_writer)
            ...
            self.log_writer.log(self.db, self.table_name, 'INFO','End of Prediction')
        except Exception as e:
            self.log_writer.log(self.db, self.table_name, 'ERROR', 'Error occured while running the prediction!! Error:: %s' % e)
            raise e
        return path
